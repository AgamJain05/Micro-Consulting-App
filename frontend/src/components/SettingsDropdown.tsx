  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center gap-2 px-5 py-2.5 rounded-2xl bg-white hover:bg-gray-50 transition border border-gray-200 text-gray-700 shadow-sm"
      >
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute right-0 mt-2 w-96 bg-white rounded-3xl shadow-2xl border border-gray-100 z-50 overflow-hidden">
          {/* Header */}
